...
class UglyProvider extends StatefulWidget {
  ...
  static _UglyProviderState of(BuildContext context, {bool subscribe = true}) {
    return subscribe
        ? context.dependOnInheritedWidgetOfExactType<_UglyProvider>().data
        : (context.getElementForInheritedWidgetOfExactType<_UglyProvider>().widget as _UglyProvider).data;
  }
}
